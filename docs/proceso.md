...
# Entidad CLIENTE – Proyecto ActivaFit

#### **.1 — features/business/clients/domain/entities/client.entity.ts**

![](images/clipboard-2091536219.png)

#### **.2 — features/business/clients/domain/exceptions/client-email-already-exists.exception.ts**

![](images/clipboard-1063677338.png)

#### **.3 — features/business/clients/domain/exceptions/client-not-found.exception.ts**

![](images/clipboard-1608897309.png)

#### **.4 — features/business/clients/domain/interfaces/client-repository.interface.ts**

![](images/clipboard-3418246264.png)

#### **.5 — features/business/clients/domain/validators/client-email.validator.ts**

![](images/clipboard-1572209675.png)

#### **.6 — features/business/clients/domain/validators/client-phone.validator.ts**

![](images/clipboard-2275250678.png)

#### **.7 — features/business/clients/infrastructure/persistence/models/client.model.ts**

![](images/clipboard-1032423571.png)

#### **.8 — features/business/clients/infrastructure/persistence/repositories/client.repository.ts**

![](images/clipboard-674383065.png)

#### **.9 — features/business/clients/infrastructure/persistence/migrations/create-clients-table.migration.ts**

![](images/clipboard-4100343986.png)

#### **.10 — features/business/clients/infrastructure/persistence/seeders/clients.seeder.ts**

![](images/clipboard-2760031736.png)

#### **.11 — features/business/clients/application/dto/client-filter.dto.ts**

![](images/clipboard-1954332729.png)

#### **.12 — features/business/clients/application/dto/client-response.dto.ts**

![](images/clipboard-693423345.png)

#### **.13 — features/business/clients/application/dto/create-client.dto.ts**

![](images/clipboard-502276473.png)

#### **.14 — features/business/clients/application/dto/update-client.dto.ts**

![](images/clipboard-1544644479.png)

#### **.15 — features/business/clients/application/mappers/client.mapper.ts**

![](images/clipboard-1654460731.png)

#### **.16 — features/business/clients/application/use-cases/create-client.use-case.ts**

![](images/clipboard-1182362516.png)

#### **.17 — features/business/clients/application/use-cases/delete-client.use-case.ts**

![](images/clipboard-4269119395.png)

#### **.18 — features/business/clients/application/use-cases/get-client.use-case.ts**

![](images/clipboard-900116999.png)

#### **.19 — features/business/clients/application/use-cases/list-clients.use-case.ts**

![](images/clipboard-1248325068.png)

#### **.20 — features/business/clients/application/use-cases/update-client.use-case.ts**

![](images/clipboard-2718061128.png)

#### **.21 — features/business/clients/presentation/http/serializers/client.serializer.ts**

![](images/clipboard-756915205.png)

#### **.22 — features/business/clients/presentation/http/controllers/clients.controller.ts**

![](images/clipboard-2225957795.png)
...
![](images/clipboard-1154106621.png)

#### **.26 — Actualizar business.module.ts**

![](images/clipboard-2946129616.png)
...
![](images/clipboard-3728882459.png)

# Entidad PLAN – Proyecto ActivaFit

#### **.1 — features/business/clients/domain/entities/client.entity.ts**

![](images/clipboard-502749970.png)

#### **.2 — features/business/clients/domain/exceptions/client-email-already-exists.exception.ts**

![](images/clipboard-2707586672.png)

#### **.3 — features/business/clients/domain/exceptions/client-not-found.exception.ts**

![](images/clipboard-3641654250.png)

#### **.4 — features/business/clients/domain/interfaces/client-repository.interface.ts**

![](images/clipboard-396432650.png)

#### **.5 — features/business/clients/domain/validators/client-email.validator.ts**

![](images/clipboard-1603255617.png)

#### **.6 — features/business/clients/domain/validators/client-phone.validator.ts**

![](images/clipboard-3372009591.png)

#### **.7 — features/business/clients/infrastructure/persistence/models/client.model.ts**

![](images/clipboard-2365277303.png)

#### **.8 — features/business/clients/infrastructure/persistence/repositories/client.repository.ts**

![](images/clipboard-3633321924.png)

#### **.9 — features/business/clients/infrastructure/persistence/migrations/create-clients-table.migration.ts**

![](images/clipboard-3909888825.png)

#### **.10 — features/business/clients/infrastructure/persistence/seeders/clients.seeder.ts**

![](images/clipboard-840076094.png)

#### **.11 — features/business/clients/application/dto/client-filter.dto.ts**

![](images/clipboard-1662706527.png)

#### **.12 — features/business/clients/application/dto/client-response.dto.ts**

![](images/clipboard-3115356406.png)

#### **.13 — features/business/clients/application/dto/create-client.dto.ts**

![](images/clipboard-2289101476.png)

#### **.14 — features/business/clients/application/dto/update-client.dto.ts**

![](images/clipboard-2350399525.png)

#### **.15 — features/business/clients/application/mappers/client.mapper.ts**

![](images/clipboard-677825296.png)

#### **.16 — features/business/clients/application/use-cases/create-client.use-case.ts**

![](images/clipboard-2962285869.png)

#### **.17 — features/business/clients/application/use-cases/delete-client.use-case.ts**

![](images/clipboard-2580949166.png)

#### **.18 — features/business/clients/application/use-cases/get-client.use-case.ts**

![](images/clipboard-1996441206.png)

#### **.19 — features/business/clients/application/use-cases/list-clients.use-case.ts**

![](images/clipboard-3911323446.png)

#### **.20 — features/business/clients/application/use-cases/update-client.use-case.ts**

![](images/clipboard-1138855437.png)
...
![](images/clipboard-1689338297.png)

#### **.24 — features/business/clients/clients.module.ts**

![](images/clipboard-3324475083.png)

#### **.25 — Actualizar sequelize.factory.ts (registrar modelos)**

![](images/clipboard-2251047456.png)

#### **.26 — Actualizar business.module.ts**

![](images/clipboard-2288635362.png)

#### **.27 — Actualizar database-seeder.service.ts**

![](images/clipboard-3330415886.png)

#### **.28 — Actualizar app.module.ts**

![](images/clipboard-53011725.png)
...
![](images/clipboard-387554344.png)

#### **.3 — features/business/clients/domain/exceptions/client-not-found.exception.ts**

![](images/clipboard-3487990806.png)

#### **.4 — features/business/clients/domain/interfaces/client-repository.interface.ts**

![](images/clipboard-2536335285.png)

#### **.5 — features/business/clients/domain/validators/client-email.validator.ts**

![](images/clipboard-4037640152.png)

#### **.6 — features/business/clients/domain/validators/client-phone.validator.ts**

![](images/clipboard-3596404202.png)

#### **.7 — features/business/clients/infrastructure/persistence/models/client.model.ts**

![](images/clipboard-2900132497.png)
...
![](images/clipboard-438424200.png)

#### **.11 — features/business/clients/application/dto/client-filter.dto.ts**

![](images/clipboard-1460012717.png)

#### **.12 — features/business/clients/application/dto/client-response.dto.ts**

![](images/clipboard-2350684320.png)

#### **.13 — features/business/clients/application/dto/create-client.dto.ts**

![](images/clipboard-2846012844.png)

#### **.14 — features/business/clients/application/dto/update-client.dto.ts**

![](images/clipboard-3265005719.png)

#### **.15 — features/business/clients/application/mappers/client.mapper.ts**

![](images/clipboard-1081286226.png)

#### **.16 — features/business/clients/application/use-cases/create-client.use-case.ts**

![](images/clipboard-2235787785.png)

#### **.17 — features/business/clients/application/use-cases/delete-client.use-case.ts**

![](images/clipboard-119472971.png)

#### **.18 — features/business/clients/application/use-cases/get-client.use-case.ts**

![](images/clipboard-1872430916.png)

#### **.19 — features/business/clients/application/use-cases/list-clients.use-case.ts**

![](images/clipboard-1602382164.png)

#### **.20 — features/business/clients/application/use-cases/update-client.use-case.ts**

![](images/clipboard-834620135.png)

#### **.21 — features/business/clients/presentation/http/serializers/client.serializer.ts**

![](images/clipboard-2177528225.png)

#### **.22 — features/business/clients/presentation/http/controllers/clients.controller.ts**

![](images/clipboard-2957160817.png)

#### **.23 — features/business/clients/index.ts**

![](images/clipboard-363714873.png)

#### **.24 — features/business/clients/clients.module.ts**

![](images/clipboard-1719431917.png)
...
![](images/clipboard-2239099183.png)

#### **.29 — Verificar tabla física `clients` y API**

![](images/clipboard-1024272791.png)

# Entidad ASISTENCIA – Proyecto ActivaFit

#### **.1 — features/business/clients/domain/entities/client.entity.ts**

![](images/clipboard-3086835365.png)

#### **.2 — features/business/clients/domain/exceptions/client-email-already-exists.exception.ts**

![](images/clipboard-447452266.png)

#### **.3 — features/business/clients/domain/exceptions/client-not-found.exception.ts**

![](images/clipboard-3166725443.png)

#### **.4 — features/business/clients/domain/interfaces/client-repository.interface.ts**

![](images/clipboard-2640215339.png)

#### **.5 — features/business/clients/domain/validators/client-email.validator.ts**

![](images/clipboard-397633759.png)

#### **.6 — features/business/clients/domain/validators/client-phone.validator.ts**

![](images/clipboard-1591546096.png)

#### **.7 — features/business/clients/infrastructure/persistence/models/client.model.ts**

![](images/clipboard-1586190357.png)

#### **.8 — features/business/clients/infrastructure/persistence/repositories/client.repository.ts**

![](images/clipboard-471394984.png)

#### **.9 — features/business/clients/infrastructure/persistence/migrations/create-clients-table.migration.ts**

![](images/clipboard-3409463411.png)

#### **.10 — features/business/clients/infrastructure/persistence/seeders/clients.seeder.ts**

![](images/clipboard-2896083471.png)

#### **.11 — features/business/clients/application/dto/client-filter.dto.ts**

![](images/clipboard-2279003976.png)

#### **.12 — features/business/clients/application/dto/client-response.dto.ts**

![](images/clipboard-1851270919.png)

#### **.13 — features/business/clients/application/dto/create-client.dto.ts**

![](images/clipboard-1589619272.png)

#### **.14 — features/business/clients/application/dto/update-client.dto.ts**

![](images/clipboard-1709827002.png)

#### **.15 — features/business/clients/application/mappers/client.mapper.ts**

![](images/clipboard-2498498819.png)

#### **.16 — features/business/clients/application/use-cases/create-client.use-case.ts**

![](images/clipboard-2829335975.png)

#### **.17 — features/business/clients/application/use-cases/delete-client.use-case.ts**

![](images/clipboard-3184070255.png)

#### **.18 — features/business/clients/application/use-cases/get-client.use-case.ts**

![](images/clipboard-1713274374.png)

#### **.19 — features/business/clients/application/use-cases/list-clients.use-case.ts**

![](images/clipboard-2846894163.png)

#### **.20 — features/business/clients/application/use-cases/update-client.use-case.ts**

![](images/clipboard-3152934439.png)

#### **21 — features/business/clients/presentation/http/serializers/client.serializer.ts**

![](images/clipboard-1110372415.png)

#### **.22 — features/business/clients/presentation/http/controllers/clients.controller.ts**

![](images/clipboard-3367852908.png)

#### **.23 — features/business/clients/index.ts**

![](images/clipboard-1538335726.png)

#### **.24 — features/business/clients/clients.module.ts**

![](images/clipboard-134163172.png)

#### **.25 — Actualizar sequelize.factory.ts (registrar modelos)**

![](images/clipboard-2699583391.png)

#### **.26 — Actualizar business.module.ts**

![](images/clipboard-2853498115.png)

#### **.27 — Actualizar database-seeder.service.ts**

![](images/clipboard-2431392955.png)

#### **.28 — Actualizar app.module.ts**

![](images/clipboard-17275343.png)
...
![](images/clipboard-3102039923.png)

#### **.3 — features/business/clients/domain/exceptions/client-not-found.exception.ts**

![](images/clipboard-3644127681.png)

#### **.4 — features/business/clients/domain/interfaces/client-repository.interface.ts**

![](images/clipboard-1999125363.png)

#### **.5 — features/business/clients/domain/validators/client-email.validator.ts**

![](images/clipboard-4221256355.png)

#### **.6 — features/business/clients/domain/validators/client-phone.validator.ts**

![](images/clipboard-4021491426.png)

#### **.7 — features/business/clients/infrastructure/persistence/models/client.model.ts**

![](images/clipboard-1840884708.png)

#### **.8 — features/business/clients/infrastructure/persistence/repositories/client.repository.ts**

![](images/clipboard-3302738295.png)

#### **.9 — features/business/clients/infrastructure/persistence/migrations/create-clients-table.migration.ts**

![](images/clipboard-4123690341.png)

#### **.10 — features/business/clients/infrastructure/persistence/seeders/clients.seeder.ts**

![](images/clipboard-3065181923.png)
...
![](images/clipboard-2103904491.png)

#### **.14 — features/business/clients/application/dto/update-client.dto.ts**

![](images/clipboard-2055258930.png)

#### **.15 — features/business/clients/application/mappers/client.mapper.ts**

![](images/clipboard-712984790.png)

#### **.16 — features/business/clients/application/use-cases/create-client.use-case.ts**

![](images/clipboard-3282718673.png)
...
![](images/clipboard-686938683.png)

#### **.20 — features/business/clients/application/use-cases/update-client.use-case.ts**

![](images/clipboard-1546493485.png)

#### **.21 — features/business/clients/presentation/http/serializers/client.serializer.ts**

![](images/clipboard-3468416308.png)

#### **.22 — features/business/clients/presentation/http/controllers/clients.controller.ts**

![](images/clipboard-3424941264.png)

#### **.23 — features/business/clients/index.ts**

![](images/clipboard-3170444111.png)

#### **.24 — features/business/clients/clients.module.ts**

![](images/clipboard-1149808470.png)

#### **.25 — Actualizar sequelize.factory.ts (registrar modelos)**

![](images/clipboard-156357184.png)

#### **.26 — Actualizar business.module.ts**

![](images/clipboard-1241054842.png)

#### **.27 — Actualizar database-seeder.service.ts**

![](images/clipboard-3243948241.png)
...
# Entidad RUTINA – Proyecto ActivaFi

#### **.1 — features/business/clients/domain/entities/client.entity.ts**

![](images/clipboard-981135807.png)

#### **.2 — features/business/clients/domain/exceptions/client-email-already-exists.exception.ts**

![](images/clipboard-3405157710.png)

#### **.3 — features/business/clients/domain/exceptions/client-not-found.exception.ts**

![](images/clipboard-1831825968.png)

#### **.4 — features/business/clients/domain/interfaces/client-repository.interface.ts**

![](images/clipboard-2651157808.png)

#### **.5 — features/business/clients/domain/validators/client-email.validator.ts**

![](images/clipboard-369944074.png)

#### **.6 — features/business/clients/domain/validators/client-phone.validator.ts**

![](images/clipboard-3952886225.png)

#### **.7 — features/business/clients/infrastructure/persistence/models/client.model.ts**

![](images/clipboard-3630547102.png)

#### **.8 — features/business/clients/infrastructure/persistence/repositories/client.repository.ts**

![](images/clipboard-3802844365.png)

#### **.9 — features/business/clients/infrastructure/persistence/migrations/create-clients-table.migration.ts**

![](images/clipboard-2424532175.png)

#### **.10 — features/business/clients/infrastructure/persistence/seeders/clients.seeder.ts**

![](images/clipboard-1704206385.png)

#### **.11 — features/business/clients/application/dto/client-filter.dto.ts**

![](images/clipboard-3055645907.png)

#### **.12 — features/business/clients/application/dto/client-response.dto.ts**

![](images/clipboard-1993746198.png)

#### **.13 — features/business/clients/application/dto/create-client.dto.ts**

![](images/clipboard-386513800.png)

#### **.14 — features/business/clients/application/dto/update-client.dto.ts**

![](images/clipboard-432896840.png)

#### **.15 — features/business/clients/application/mappers/client.mapper.ts**

![](images/clipboard-2412446658.png)
...
# Entidad PAGO – Proyecto ActivaFit
...
![](images/clipboard-1420285277.png)

#### **.4 — features/business/clients/domain/interfaces/client-repository.interface.ts**

![](images/clipboard-948095830.png)

#### **.5 — features/business/clients/domain/validators/client-email.validator.ts**

![](images/clipboard-609572558.png)

#### **.6 — features/business/clients/domain/validators/client-phone.validator.ts**

![](images/clipboard-3705647860.png)

#### **.7 — features/business/clients/infrastructure/persistence/models/client.model.ts**

![](images/clipboard-1720692510.png)

#### **7.8 — features/business/clients/infrastructure/persistence/repositories/client.repository.ts**

![](images/clipboard-513085736.png)

#### **.9 — features/business/clients/infrastructure/persistence/migrations/create-clients-table.migration.ts**

![](images/clipboard-1992426286.png)

#### **.10 — features/business/clients/infrastructure/persistence/seeders/clients.seeder.ts**

![](images/clipboard-2126652867.png)

#### **.11 — features/business/clients/application/dto/client-filter.dto.ts**

![](images/clipboard-2720303041.png)

#### **.12 — features/business/clients/application/dto/client-response.dto.ts**

![](images/clipboard-1078605552.png)

#### **.13 — features/business/clients/application/dto/create-client.dto.ts**

![](images/clipboard-3643053958.png)

#### **.14 — features/business/clients/application/dto/update-client.dto.ts**

![](images/clipboard-2622068061.png)

#### **.15 — features/business/clients/application/mappers/client.mapper.ts**

![](images/clipboard-2764941113.png)

#### **— Verificar tabla física** 

![](images/clipboard-2456776408.png)
